...
\end{tikzpicture}
\vspace*{140mm}
\caption{Proof of the remote-target method: implementation of multiple non-local CNOT gates that share a common target, using a single ebit. The proof uses properties given in Figures~\ref{fig:props}, \ref{fig:sliding} and~\ref{fig:nonlocalCNOTs}. The distributed circuit is similar to the one for the remote-control method (Figure~\ref{fig:nonlocalCNOTs}). Both cat-entangler and cat-disentangler slightly differ.}
